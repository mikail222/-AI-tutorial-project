  ...
  return (
    <div className="flex flex-row">
      <div className="hidden lg:flex  flex-col  w-[60vw] bg-[#ffffdb] h-[100vh]">
        <div className="flex flex-row items-center text-[#fe7600] font-bold text-[1.5rem]  p-[3%]">
          <p>ChatGPT </p>
          <p className="bg-[#fe7600]  w-[1.3rem] h-[1.3rem] rounded-[100px]"></p>
        </div>
      </div>
      <div className="w-[100vw] lg:w-[40vw] h-[100vh] flex flex-col">
        <div className="w-[100%] h-[100vh] flex flex-col">
          ...
          <div className="openai">
            <div className="font-bold text-[1.1rem] text-gray-300">
              <img
            ...
            <div className="text-[gray] w-[50%] text-[.8rem] cursor-pointer">
              <p>Term of use</p>
